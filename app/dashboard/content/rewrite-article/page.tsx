...
export default function RewriteArticlePage() {
  return (
    <div className="flex h-full bg-gray-100">
      {/* Left Panel - Rewrite Article Input */}
      <div className="w-1/3 p-6 bg-white border-r border-gray-200 flex flex-col">
        <h2 className="text-2xl font-bold mb-4 text-gray-950">Rewrite Article (Plagiarism)</h2>
